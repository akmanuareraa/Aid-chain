  ...
  return (
    <>
      <div className="flex flex-col items-center mt-10">
        <p className="font-bold py-6">Login for Storage Facility</p>
        ...
        <button
          ...
          onClick={async () => {
            if (props.appState.account === "") {
              ...
              await props.loginSFacility(formData.username, formData.password);
            }
          }}
        >
          login
